...
set_property PACKAGE_PIN P3 [get_ports {test[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {test[12]}]
set_property PACKAGE_PIN N3 [get_ports {test[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {test[13]}]
set_property PACKAGE_PIN P1 [get_ports {test[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {test[14]}]
set_property PACKAGE_PIN L1 [get_ports {test[15]}]					
